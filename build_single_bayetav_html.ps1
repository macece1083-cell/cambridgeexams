...
Narrator: KET Test Two, Listening Part One. You will hear five short conversations. One. Boy: Did you buy fruit at the market? Girl: I nearly bought apples, and I looked at a scarf too. But the stallholder repaired the small silver bracelet while I waited, so that is what I bought. Two. Girl: Is your brother playing guitar in the concert? Boy: He practised guitar first, then piano, but the band already had those. In the end he moved to the drums. Three. Mother: Are you going to the club now? Boy: I wanted to, and my bag is ready. Mother: But the teacher's message? Boy: Yes, I saw it at the end. I have to finish the homework before I go. Four. Girl: Was your grandad born in 1956? Boy: That is my dad's year. Girl: I thought you said 1960. Boy: Close, but the family book says 1965. Five. Man: It may rain later, and yesterday was cloudy. Woman: For the picnic time, though, the forecast changed. The morning will be sunny. Narrator: Now listen again.
'@
  $audioScriptOverrides['ket_test2_tts/test2_part2.wav'] = @'
Narrator: KET Test Two, Listening Part Two. Listen to a boy talking about a school technology project. Boy: The project title is Gadgets Through Time. Some students wrote history, but the final word on the poster is Time. We first planned pairs, then the teacher decided groups of four would give everyone a job. Each group must not make a model. You have to make a presentation about a gadget from the past. The presentation day is not in April. It is on March the fifteenth. The prize was going to be headphones, but the sponsor changed it. The best project wins a tablet. Narrator: Now listen again.
'@
  $audioScriptOverrides['ket_test2_tts/test2_part3.wav'] = @'
Narrator: KET Test Two, Listening Part Three. Listen to Zoe and Marcus talking about a school fashion show. Zoe: People think the show is about traditional clothes because of last year. Marcus: Or clothes students designed themselves? Zoe: We designed them, but the special rule is that everything must be made from recycled clothes. Marcus: Is it this Friday? Zoe: The posters were printed too early. It is next Friday. Marcus: I am not walking on stage. Zoe: Playing music? Marcus: No, I will take photographs for the school site. Zoe: My outfit looks like denim, but I am not using jeans. Marcus: Old T-shirts? Zoe: I tried those. The art teacher said the old curtains were stronger, so that is my material. Marcus: Is your mother helping? Zoe: She gave advice, but my art teacher is helping me make it. Narrator: Now listen again.
'@
  $audioScriptOverrides['ket_test2_tts/test2_part4.wav'] = @'
Narrator: KET Test Two, Listening Part Four. Listen and choose the correct answer. Sixteen. Girl: On the trip, we passed the history museum and I wanted to stop at the art museum. But our tickets were for the building with old computers and early phones, the technology museum. Seventeen. Boy: I enjoy pop songs, and traditional music is important in my family. What I like best is when musicians mix old instruments with new sounds. Eighteen. Woman: I did not throw my old clothes away, and I only gave a few buttons to the charity shop. Most of the fabric became a new bag, so I made the clothes into something new. Nineteen. Boy: My grandfather worked on a farm as a child, and he built his own house later. But his real job for many years was teaching. Twenty. Girl: I wanted headphones, and my brother suggested a camera. My parents chose something I can wear and use for messages. I got a smartwatch. Narrator: Now listen again.
'@
  $audioScriptOverrides['ket_test2_tts/test2_part5.wav'] = @'
Narrator: KET Test Two, Listening Part Five. Listen to a teacher talking about history project topics. Teacher: Nina first asked for Ancient Rome, but Carlos needed the Roman topic for another class. Nina will study Ancient Egypt. Carlos then chose the Vikings because he found a diary-style text about sea journeys. Hana likes buildings, but Jake has already chosen medieval castles, so Hana will take Ancient Greece. Jake, keep medieval castles and focus on daily life inside them. Petra wanted the Stone Age at first, but her family has old photographs from the nineteenth century, so Petra will study the Victorian era. Narrator: Now listen again.
'@
